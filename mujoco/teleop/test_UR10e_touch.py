    ...
    try:
        ...
        while True:
            ...
            if data.time < prev_sim_time:
                ...
                print(">>> RESET MUJOCO DÉTECTÉ (Touche Backspace) <<<")
            ...
            if now - last_render >= render_period:
                if viewer is not None:
                    ...
                    if key == 27: # Touche ECHAP pour quitter
                        ...
                        if model.nu > 6:
                            # forcer un état pince cohérent au reset
                            data.qpos[6] = -0.2
                            smooth_gripper_cmd = -0.2
                            data.ctrl[6] = -0.2
                        ...
                        # reset aussi l'état interne de la téléop
                        ros_node.reset_after_sim_reset()
                ...
                if is_recording:
                    if time.time() - last_record_time >= (1.0 / record_freq):
                        ...
                        img_top_84 = cv2.rotate(img_top_84, cv2.ROTATE_180)
